...
const level2Items: GameItem[] = [
  ...
  { id: 'l2item6', name: 'Kanin (Bigas)', image: '/images/likas-na-yaman/rice.svg', categoryKey: 'edibleFlora', careTip: 'Cooked rice is a staple in many diets.', learnMore: 'Kanin (Cooked Rice) gives us energy to play and learn all day!' },
