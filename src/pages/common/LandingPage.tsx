      ...
      <section className="bg-gradient-to-b from-primary-background to-white dark:from-primary-background-dark dark:to-primary-background-dark py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-3">
              <h1 className="text-4xl md:text-5xl font-bold text-primary-text dark:text-primary-text-dark mb-4 leading-tight mx-12">
                Making Learning Fun for Grade 3 Students
              </h1>
              <p className="text-lg text-gray-700 dark:text-gray-300 mb-6 mx-12">
              ...
              <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3 mx-12">
                <Link to="/register">
            ...
            <div className="md:w-1/2 md:pl-12 flex justify-center md:justify-start">
              <img 
                ...
                className="rounded-lg shadow-lg max-w-xl h-auto" 
              />
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-100 dark:bg-gray-800">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="bg-primary-card dark:bg-primary-card-dark rounded-xl shadow-sm p-8 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-24 h-24 bg-primary-interactive bg-opacity-10 dark:bg-primary-interactive-dark dark:bg-opacity-20 rounded-bl-full"></div>
              
              <div className="flex items-center mb-6">
                <div className="w-12 h-12 bg-primary-interactive bg-opacity-20 dark:bg-primary-interactive-dark dark:bg-opacity-30 rounded-full flex items-center justify-center mr-4">
              ...
              <ul className="space-y-3 text-primary-text dark:text-primary-text-dark mb-8">
                <li className="flex items-center">
                  <Star size={16} className="text-primary-energetic dark:text-primary-energetic-dark mr-2 flex-shrink-0" />
            ...
            <div className="bg-primary-card dark:bg-primary-card-dark rounded-xl shadow-sm p-8 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-24 h-24 bg-primary-accent bg-opacity-10 dark:bg-primary-accent-dark dark:bg-opacity-20 rounded-bl-full"></div>
              
              <div className="flex items-center mb-6">
                <div className="w-12 h-12 bg-primary-accent bg-opacity-20 dark:bg-primary-accent-dark dark:bg-opacity-30 rounded-full flex items-center justify-center mr-4">
